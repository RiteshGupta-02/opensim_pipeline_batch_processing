...
<OpenSimDocument Version="40000">
	<AnalyzeTool name="subject{subject}_{trial}">
		...
		<external_loads_file>../ID/grf/grf_S{subject}_{trial}.xml</external_loads_file>
		...
		<coordinates_file>../IK/results_stw/ik_output_s{subject}_{trial}.mot</coordinates_file>
