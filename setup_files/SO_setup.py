...
<OpenSimDocument Version="40000">
	<AnalyzeTool name="subject{subject}_stw{trial}">
		...
		<results_directory>result_SO</results_directory>
		<!--Output precision.  It is 8 by default.-->
		<output_precision>8</output_precision>
		<!--Initial time for the simulation.-->
		<initial_time>4</initial_time>
		<!--Final time for the simulation.-->
		<final_time>5.6200000000000001</final_time>
		...
		<external_loads_file>../ID/grf/grf_S{subject}_stw{trial}.xml</external_loads_file>
...
for trial in range(1, 6):
    ...
    # Create filename
    filename = f"so_setup_S{subject}_stw{trial}.xml"
